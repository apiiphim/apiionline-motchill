...
namespace ApiiOnline\Thememotchill\Controllers;
...
class ThememotchillController
{
    ...
    public function getMovieOfType(Request $request)
    {
        ...
        if(is_null($movies)) {
            ...
            try {
                $movies = \ApiiOnline\Core\Models\Movie::when($relation_table, function ($query) use ($relation_table, $relation_field, $relation_val, $field, $val) {
