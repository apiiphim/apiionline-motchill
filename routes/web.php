...
use ApiiOnline\ThemeMotchill\Controllers\ThemeMotchillController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('apiionline.routes.movie', 'phim')), [ThemeMotchillController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('apiionline.routes.movie', 'phim')), [ThemeMotchillController::class, 'rateMovie'])->name('movie.rating');
